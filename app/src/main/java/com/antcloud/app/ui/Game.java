...
import com.antcloud.app.binding.audio.AndroidAudioRenderer;
import com.antcloud.app.binding.input.ControllerHandler;
import com.antcloud.app.binding.input.KeyboardTranslator;
import com.antcloud.app.binding.input.capture.InputCaptureManager;
import com.antcloud.app.binding.input.capture.InputCaptureProvider;
import com.antcloud.app.binding.input.touch.AbsoluteTouchContext;
import com.antcloud.app.binding.input.touch.RelativeTouchContext;
import com.antcloud.app.binding.input.driver.UsbDriverService;
import com.antcloud.app.binding.input.evdev.EvdevListener;
import com.antcloud.app.binding.input.touch.TouchContext;

import android.app.AlertDialog;
import android.os.Build;

import com.antcloud.app.binding.input.virtual_controller.VirtualController;
import com.antcloud.app.binding.video.CrashListener;
import com.antcloud.app.binding.video.MediaCodecDecoderRenderer;
import com.antcloud.app.binding.video.MediaCodecHelper;
import com.antcloud.app.binding.video.PerfOverlayListener;
...
import com.antcloud.app.nvstream.NvConnectionListener;
import com.antcloud.app.nvstream.StreamConfiguration;
...
//    int gamepadMask;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String currentUserId = GlobalData.Companion.getInstance().getGameId();
        ...
        Log.i("test" , "testAppId" + appId + "testUniqueId" + uniqueId);
...
//        service.releaseLocalDatabaseReference();
                ...
                public void run() {
                    try (Response response = client.newCall(request).execute()) {
                        if (response.isSuccessful() && response.body() != null) {
                            ...
                            boolean connected = jObj.getBoolean("connected");
                            if (connected) {
                                GlobalData.Companion.getInstance().socket.emit("control", "video");
                                timer.cancel();
                                timer = null;
                            }
                        } else {
