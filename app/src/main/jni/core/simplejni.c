...
Java_com_antcloud_app_nvstream_jni_AntBridge_sendMouseMove(JNIEnv *env, jclass clazz, jshort deltaX, jshort deltaY) {
    LiSendMouseMoveEvent(deltaX, deltaY);
}

JNIEXPORT void JNICALL
Java_com_antcloud_app_nvstream_jni_AntBridge_sendMousePosition(JNIEnv *env, jclass clazz,
...
JNIEXPORT void JNICALL
Java_com_antcloud_app_nvstream_jni_AntBridge_sendMouseMoveAsMousePosition(JNIEnv *env, jclass clazz,
...
JNIEXPORT void JNICALL
Java_com_antcloud_app_nvstream_jni_AntBridge_sendMouseButton(JNIEnv *env, jclass clazz, jbyte buttonEvent, jbyte mouseButton) {
    LiSendMouseButtonEvent(buttonEvent, mouseButton);
}

JNIEXPORT void JNICALL
Java_com_antcloud_app_nvstream_jni_AntBridge_sendMultiControllerInput(JNIEnv *env, jclass clazz, jshort controllerNumber,
...
Java_com_antcloud_app_nvstream_jni_AntBridge_sendTouchEvent(JNIEnv *env, jclass clazz,
...
JNIEXPORT jint JNICALL
Java_com_antcloud_app_nvstream_jni_AntBridge_sendPenEvent(JNIEnv *env, jclass clazz, jbyte eventType,
...
JNIEXPORT jint JNICALL
Java_com_antcloud_app_nvstream_jni_AntBridge_sendControllerArrivalEvent(JNIEnv *env, jclass clazz,
...
JNIEXPORT jint JNICALL
Java_com_antcloud_app_nvstream_jni_AntBridge_sendControllerTouchEvent(JNIEnv *env, jclass clazz,
                                                                      jbyte controllerNumber,
                                                                      jbyte eventType,
...
JNIEXPORT jint JNICALL
Java_com_antcloud_app_nvstream_jni_AntBridge_sendControllerMotionEvent(JNIEnv *env, jclass clazz,
                                                                       jbyte controllerNumber,
...
JNIEXPORT jint JNICALL
Java_com_antcloud_app_nvstream_jni_AntBridge_sendControllerBatteryEvent(JNIEnv *env, jclass clazz,
                                                                        jbyte controllerNumber,
                                                                        jbyte batteryState,
...
JNIEXPORT void JNICALL
Java_com_antcloud_app_nvstream_jni_AntBridge_sendKeyboardInput(JNIEnv *env, jclass clazz, jshort keyCode, jbyte keyAction, jbyte modifiers, jbyte flags) {
    LiSendKeyboardEvent2(keyCode, keyAction, modifiers, flags);
}

JNIEXPORT void JNICALL
Java_com_antcloud_app_nvstream_jni_AntBridge_sendMouseHighResScroll(JNIEnv *env, jclass clazz, jshort scrollAmount) {
    LiSendHighResScrollEvent(scrollAmount);
}

JNIEXPORT void JNICALL
Java_com_antcloud_app_nvstream_jni_AntBridge_sendMouseHighResHScroll(JNIEnv *env, jclass clazz, jshort scrollAmount) {
    LiSendHighResHScrollEvent(scrollAmount);
}

JNIEXPORT void JNICALL
Java_com_antcloud_app_nvstream_jni_AntBridge_sendUtf8Text(JNIEnv *env, jclass clazz, jstring text) {
...
JNIEXPORT void JNICALL
Java_com_antcloud_app_nvstream_jni_AntBridge_stopConnection(JNIEnv *env, jclass clazz) {
    LiStopConnection();
}

JNIEXPORT void JNICALL
Java_com_antcloud_app_nvstream_jni_AntBridge_interruptConnection(JNIEnv *env, jclass clazz) {
    LiInterruptConnection();
}

JNIEXPORT jstring JNICALL
Java_com_antcloud_app_nvstream_jni_AntBridge_getStageName(JNIEnv *env, jclass clazz, jint stage) {
    return (*env)->NewStringUTF(env, LiGetStageName(stage));
}

JNIEXPORT jstring JNICALL
Java_com_antcloud_app_nvstream_jni_AntBridge_findExternalAddressIP4(JNIEnv *env, jclass clazz, jstring stunHostName, jint stunPort) {
    int err;
...
JNIEXPORT jint JNICALL
Java_com_antcloud_app_nvstream_jni_AntBridge_getPendingAudioDuration(JNIEnv *env, jclass clazz) {
    return LiGetPendingAudioDuration();
}

JNIEXPORT jint JNICALL
Java_com_antcloud_app_nvstream_jni_AntBridge_getPendingVideoFrames(JNIEnv *env, jclass clazz) {
    return LiGetPendingVideoFrames();
}

JNIEXPORT jint JNICALL
Java_com_antcloud_app_nvstream_jni_AntBridge_testClientConnectivity(JNIEnv *env, jclass clazz, jstring testServerHostName, jint referencePort, jint testFlags) {
    int ret;
...
JNIEXPORT jint JNICALL
Java_com_antcloud_app_nvstream_jni_AntBridge_getPortFlagsFromStage(JNIEnv *env, jclass clazz, jint stage) {
    return LiGetPortFlagsFromStage(stage);
}

JNIEXPORT jint JNICALL
Java_com_antcloud_app_nvstream_jni_AntBridge_getPortFlagsFromTerminationErrorCode(JNIEnv *env, jclass clazz, jint errorCode) {
    return LiGetPortFlagsFromTerminationErrorCode(errorCode);
}

JNIEXPORT jstring JNICALL
Java_com_antcloud_app_nvstream_jni_AntBridge_stringifyPortFlags(JNIEnv *env, jclass clazz, jint portFlags, jstring separator) {
...
Java_com_antcloud_app_nvstream_jni_AntBridge_getEstimatedRttInfo(JNIEnv *env, jclass clazz) {
...
JNIEXPORT jstring JNICALL
Java_com_antcloud_app_nvstream_jni_AntBridge_getLaunchUrlQueryParameters(JNIEnv *env, jclass clazz) {
    return (*env)->NewStringUTF(env, LiGetLaunchUrlQueryParameters());
}

JNIEXPORT jbyte JNICALL
Java_com_antcloud_app_nvstream_jni_AntBridge_guessControllerType(JNIEnv *env, jclass clazz, jint vendorId, jint productId) {
...
Java_com_antcloud_app_nvstream_jni_AntBridge_guessControllerHasPaddles(JNIEnv *env, jclass clazz, jint vendorId, jint productId) {
...
JNIEXPORT jboolean JNICALL
Java_com_antcloud_app_nvstream_jni_AntBridge_guessControllerHasShareButton(JNIEnv *env, jclass clazz, jint vendorId, jint productId) {
    // Xbox Elite and DualSense Edge controllers have paddles
